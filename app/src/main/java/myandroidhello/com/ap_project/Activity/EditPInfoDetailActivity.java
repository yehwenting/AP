...
public class EditPInfoDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addItemsOnSpinner("weight",weight,40,150);
        addItemsOnSpinner("height",height,145,210);
        ...
        weight.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
            ...
            public void onNothingSelected(AdapterView arg0) {
                Toast.makeText(EditPInfoDetailActivity.this, "您沒有選擇任何項目", Toast.LENGTH_LONG).show();
            }
        });
        ...
        //button
        finish.setOnClickListener(EditPInfoDetailActivity.this);
        back.setOnClickListener(EditPInfoDetailActivity.this);
    ...
    private void displayProfileInfo() {
        ...
        String ecard = User.getEzcard();
        this.ezcard.setText(ecard);
            ...
            StringRequest stringRequest=new StringRequest(Request.Method.POST, Values.lOGIN_SERVER_URL,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                GlobalVariables User = (GlobalVariables)getApplicationContext();
                                User.setHeight(selectHeight);
                                User.setWeight(selectWeight);
                                User.setEzcard(ezcard.getText().toString());
                                User.setCollege(selectCollege);
                                User.setDepartment(selectDepartment);
...
//                                    saveGroceryToServer(view);
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    String query=mysql.updateUserDetailToMysql(User.getId(),selectHeight,selectWeight,ezcard.getText().toString(),selectCollege,selectDepartment);
            ...
            MySingleTon.getmInstance(EditPInfoDetailActivity.this).addToRequestque(stringRequest);
        }else{
    ...
    public void addItemsOnSpinner(String k,Spinner spinner, int start, int end) {
        GlobalVariables User = (GlobalVariables)getApplicationContext();
        ...
        if(k.equals("weight")) {
            ...
            spinner.setSelection(adapter.getPosition(weight1));
        }else{
            int height1 = Integer.parseInt(User.getHeight());
            spinner.setSelection(adapter.getPosition(height1));
        }
    }
